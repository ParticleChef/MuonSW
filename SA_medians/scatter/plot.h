...
*/
   if (tree == 0) {
	     ...
	     if(!f || !f->IsOpen()){
		     ...
		     //f = new TFile("/xrootd/store/user/jhong/SingleMu_Pt2to200_Eta3p0_CMSSW_9_3_7_NoPU_D17test/crab_Muon0802/180802_123200/0000/");
	    ...
	    chain->Add("root://cms-xrdr.private.lo:2094//xrd/store/user/jhong/SingleMu_FlatPt-2to100/crab_SingleMuNoPU/190227_114927/0000/*.root/l1PiXTRKTree/L1PiXTRKTree");
